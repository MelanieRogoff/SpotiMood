  ...
  return (
    ...
    <Box className="homeScreen">
      ...
      <Typography variant='h6' className={'headers'}>
        ...
        {/* for any components that don't have children (aka other components in between them) we can just call the component like this. 0 performance boost, but its less things to read on the screen
        */}
      <Smiley/>
      <SpotifyBox/>
    </Box>
